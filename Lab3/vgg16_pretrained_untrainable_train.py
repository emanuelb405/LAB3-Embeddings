## train with vgg with imagenet weights and untrainable  vgg16_pretrained_untrainable"""

from keras.models import model_from_json
weights_file = "models/vgg16_pretrained_untrainable.hdf5"
json_file = open('models/vgg16_pretrained_untrainable.json','r')
...
checkpoint = ModelCheckpoint(
    'models/vgg16_pretrained_untrainable.model',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
    mode='min',
...
csvlogger = CSVLogger(
    filename= "results/vgg16_pretrained_untrainable_training_csv.log",
    separator = ",",
    append = False
)
