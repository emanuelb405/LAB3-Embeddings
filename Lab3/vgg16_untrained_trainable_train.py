## Run training vgg without pretrained weights  vgg16_untrained_trainable


from keras.models import model_from_json
weights_file = "models/vgg16_untrained_trainable.hdf5"
json_file = open('models/vgg16_untrained_trainable.json','r')
...
checkpoint = ModelCheckpoint(
    'models/vgg16_untrained_trainable.model',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
    mode='min',
