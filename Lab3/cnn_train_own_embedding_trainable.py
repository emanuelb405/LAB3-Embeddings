# -*- coding: utf-8 -*-
"""cnn_train_own_embedding_trainable.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EomIno5cD71lx5jpHZVsRkSLrzan3iy5
...
checkpoint = ModelCheckpoint(
    'models/best_cnn_train_own_embedding_trainable.model',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
    mode='min',
...
csvlogger = CSVLogger(
    filename= "results/cnn_train_own_embedding_trainable_training_csv.log",
    separator = ",",
    append = False
)
