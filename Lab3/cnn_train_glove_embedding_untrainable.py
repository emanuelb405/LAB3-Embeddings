# -*- coding: utf-8 -*-
"""cnn_train_glove_embedding_untrainable.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1anRFIkW0NmwoZTeC_4kdR_X65VWTmK9I
...
checkpoint = ModelCheckpoint(
    'models/best_cnn_train_glove_embedding_untrainable.model',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
    mode='min',
...
csvlogger = CSVLogger(
    filename= "results/cnn_train_glove_embedding_untrainable_training_csv.log",
    separator = ",",
    append = False
)
