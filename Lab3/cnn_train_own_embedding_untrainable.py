# -*- coding: utf-8 -*-
"""cnn_train_own_embedding_untrainable.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qU_EmQS_leDnFOZJ05wR1DnNUQLwNuuR
...
raw_embedding = load_embedding('models/embedding_word2vec_.txt')
# get vectors in the right order
embedding_vectors = get_weight_matrix(raw_embedding, tokenizer.word_index)

embedding_layer = Embedding(len(tokenizer.word_index)+1, 100, weights=[embedding_vectors], input_length=max_length, trainable=False)

from keras.callbacks import ModelCheckpoint, EarlyStopping, TensorBoard, CSVLogger, ReduceLROnPlateau

checkpoint = ModelCheckpoint(
    'models/best_cnn_train_own_embedding_untrainable.model',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
    mode='min',
...
csvlogger = CSVLogger(
    filename= "results/cnn_train_own_embedding_untrainable_training_csv.log",
    separator = ",",
    append = False
)
